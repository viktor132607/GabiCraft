      ...
      <div className="mx-auto w-[min(1180px,calc(100%_-_40px))] py-[72px] max-[620px]:w-[min(1180px,calc(100%_-_28px))] max-[620px]:py-12">
        <div className="grid grid-cols-[1.45fr_0.8fr_1fr] gap-14 max-[900px]:grid-cols-2 max-[900px]:gap-10 max-[620px]:grid-cols-1 max-[620px]:gap-12">
          <div className="max-[900px]:col-span-2 max-[620px]:col-span-1">
            ...
            {(facebookUrl || instagramUrl) && (
              <div className="mt-7 flex items-center gap-4" aria-label="Социални профили">
                {facebookUrl && (
                  <a
                    href={facebookUrl}
                    target="_blank"
                    rel="noreferrer"
                    aria-label="GabiCraft във Facebook"
                ...
                {instagramUrl && (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    aria-label="GabiCraft в Instagram"
                    className="flex h-12 w-12 items-center justify-center rounded-full bg-[#2d2a22] text-white transition hover:opacity-80"
                  >
          ...
          <nav aria-label="Навигация във футъра">
            <h2 className="mb-5 text-lg font-bold text-[#202534]">Страници</h2>
          ...
          <section aria-labelledby="footer-info-heading">
            <h2 id="footer-info-heading" className="mb-5 text-lg font-bold text-[#202534]">Информация</h2>
            <div className="grid gap-4 text-[16px] text-[#697386]">
        ...
        {contactEmail && (
          <div className="mt-14 grid gap-4 text-[16px] max-[620px]:mt-10">
            <a className="flex items-center gap-3 transition hover:text-[#2d2a22]" href={`mailto:${contactEmail}`}>
