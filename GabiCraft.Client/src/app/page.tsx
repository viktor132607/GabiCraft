...
const designConcepts = [
  {
    ...
    label: "Лого · Цветове · Типография",
    art: "bg-[linear-gradient(145deg,#f5d66d_0%,#f7e9bf_48%,#7d8a55_100%)]",
  },
  {
    title: "Уеб визия",
    label: "Структура · UI · Визуален стил",
    art: "bg-[linear-gradient(155deg,#efe3cf_0%,#c69159_50%,#4f5a3c_100%)]",
  },
  {
    title: "Визуална система",
    label: "Стил · Елементи · Приложения",
    art: "bg-[linear-gradient(135deg,#d9c27a_0%,#f7f0dc_46%,#8c7042_100%)]",
  },
];
    ...
    <>
      <section className="relative overflow-hidden bg-[#fffaf0] py-24 max-[820px]:py-16 max-[620px]:py-12">
        ...
        <div className="mx-auto grid w-[min(1180px,calc(100%_-_40px))] grid-cols-[1.08fr_.92fr] items-center gap-[72px] max-[900px]:grid-cols-1 max-[900px]:gap-10 max-[620px]:w-[min(1180px,calc(100%_-_28px))]">
          <div className="relative z-10">
            ...
            <h1 className="mb-6 max-w-[780px] font-serif text-[clamp(52px,7vw,92px)] leading-[0.98] tracking-[-0.04em] text-[#2d2a22] max-[620px]:text-[clamp(42px,13vw,62px)]">Изкуство, което носи слънце.</h1>
            <p className="mb-8 max-w-[720px] text-[clamp(18px,2vw,21px)] leading-[1.7] text-[#736b5d] max-[620px]:text-base">GabiCraft е арт портфолио за картини и авторски творби, изградено около топли цветове, естествени форми и чисто представяне на работите.</p>
      ...
      <section className="bg-[#fffdf7] py-[92px] max-[820px]:py-[68px] max-[620px]:py-[54px]">
        <div className="mx-auto w-[min(1180px,calc(100%_-_40px))] max-[620px]:w-[min(1180px,calc(100%_-_28px))]">
          ...
          <div className="mt-10"><Link className="inline-block border-b border-[#b58935] pb-1 font-semibold text-[#765920]" href="/project">Разгледай цялата галерия →</Link></div>
        </div>
      </section>
