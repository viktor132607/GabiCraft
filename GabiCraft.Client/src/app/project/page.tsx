          ...
          {projectThemes.map((work, index) => (
            <article key={work.title}>
              ...
              <div className="pt-4">
                ...
                <Link
                  className="mt-4 inline-block border-b border-[#b58935] pb-1 text-sm font-semibold text-[#765920]"
                  href={`/project/${work.slug}`}
                  aria-label={`Виж повече за ${work.title}`}
                >
                  Виж направлението →
                </Link>
              </div>
